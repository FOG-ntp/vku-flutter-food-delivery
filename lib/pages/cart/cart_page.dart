...
class CartPage extends StatelessWidget {
                ...
                children: [
                  InkWell(
                    ...
                    child: const SizedBox(
                      width: double.maxFinite,
                      child: CommonTextButton(text:"Phương thức thanh toán"),
                    ),
                  ),
                  SizedBox(height: Dimensions.height10),
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            SizedBox(width: Dimensions.width10/2,),
                            BigText(text: "Tổng: " +cartController.totalAmount.toString()),
                            SizedBox(width: Dimensions.width10/2,),
                      ...
                      GestureDetector(
                          ...
                          child: CommonTextButton(text: "Đặt hàng")
                      )
                    ],
                  ),
                ],
  ...
  void _callback(bool isSuccess, String message, String orderID){
    ...
    if(isSuccess){
      ...
      print("Error in _callback: $message");
