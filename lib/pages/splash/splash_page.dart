    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          child: Center(child: Image.asset("assets/image/logofood.png", width: Dimensions.splashImg,))),
          Center(child: Image.asset("assets/image/logofood2.png", width: Dimensions.splashImg,))
        ],
      ),
    );
  }
